...
class Parser
{
    ...
    std::shared_ptr<BaseAST> ParseArrayInitVal();
    //std::shared_ptr<BaseAST> ParseArrayInitVal(std::vector<std::shared_ptr<BaseAST>> dimensions);
    //std::string ParseArrayInitVal();
